...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="container">
            <asp:Panel ID="pnlAllLogin" runat="server">
		        <div id="loginpanel">
		            <div id="loginbox">
	        ...
	        <div class="loginannouncement">
                <asp:Panel ID="pnlLicense" runat="server" Visible="false">
					<div>
						<asp:Literal id="ltLicenseText" runat="server"></asp:Literal>
                    </div>
					<center><asp:Button ID="btnLicenseAgree" runat="server" Text="I Agree" OnClick="btnLicenseAgree_Click" /></center>
				</asp:Panel>
