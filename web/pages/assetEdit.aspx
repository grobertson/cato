            ...
            <div id="left_tooltip_box_outer">
                <div id="left_tooltip_box_inner">
                    ...
                    <p>
 					...
 					<p><a href="http://projects.cloudsidekick.com/projects/cato/wiki/Assets?utm_source=cato_app&amp;utm_medium=helplink&amp;utm_campaign=app" target="_blank"><img src="../images/icons/info.png" alt="" />Click here</a>
						for a more detailed introduction on Assets.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <asp:UpdatePanel ID="uplAssetList" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <span id="lblItemsSelected">0</span> Items Selected <span id="clear_selected_btn"></span><span 
					id="item_create_btn">Create</span> <span id="item_modify_btn">Modify</span><span id="item_delete_btn">Delete</span>
